...
const md = new MarkdownIt().use(MarkdownItPrism).use(mk);
...
export default function NewPostPage() {
  ...
  // 兼容后端返回的cover_image
  useEffect(() => {
    if (form.cover === undefined && form.cover_image !== undefined && !form.coverImage) {
      setForm((prev: any) => ({ ...prev, coverImage: form.cover_image }));
    }
  }, [form.cover, form.cover_image, form.coverImage]);
